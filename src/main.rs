use ash::{version::{EntryV1_0, InstanceV1_0, DeviceV1_0}, vk};
...
impl VulkanRenderer {
    fn init(
        ...
        swapchain.create_framebuffer(&logical_device, renderpass)?;
...
impl Debug {
    fn init(entry: &ash::Entry, instance: &ash::Instance) -> Result<Debug, vk::Result> {
        ...
        let messenger = unsafe {
            loader.create_debug_utils_messenger(&debugcreateinfo, None)?
        };
...
impl Swapchain {
    fn init(
        ...
        let surface_capabilities = surfaces.get_surface_capabilities(physical_device)?;
        ...
        for _ in 0..amount_of_images {
            ...
            let fence =
                unsafe { logical_device.create_fence(&fenceinfo, None) }?;
